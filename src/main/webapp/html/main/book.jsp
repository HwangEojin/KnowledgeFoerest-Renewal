...
<div class="modal" id="loginModal">
	<div class="modal-content">
		...
		<form action="${pageContext.request.contextPath}/login/login.jsp"
			...
			<br> <input type="password" name="userPw" placeholder="비밀번호"><br>
			<br>
			<button type="submit">로그인</button>
			<button type="button" class="close-btn" id="closeLoginModal">닫기</button>
			<br> <br>
			<h4 class="join-text">회원이 아니신가요?</h4>
			<button type="button" id="openJoinFromLogin" class="join-btn">회원가입</button>
...
<div class="modal" id="joinModal">
	<div class="modal-content">
		...
		<form action="${pageContext.request.contextPath}/login/joinOk.me" method="post">
			...
			<br> <input type="text" name="userNick" placeholder="닉네임" required><br><br> 
			<input type="password" 	name="userPw" placeholder="비밀번호" required><br><br>
			<input type="password" name="userRepw" placeholder="비밀번호 재확인"	required><br><br>
			<h5>회원이신가요?</h5>
			<h6>↪︎로그인 하러가기</h6><br>
			<hr><br>
			...
			<!-- ✅ 이용약관 동의 -->
			<h4 class="join-p-labelagree">이용약관 동의</h4><br>
			<div class="join-div-wrapperprivacy">
				<textarea rows="10" cols="50" class="join-p-wrapperprivacy" readonly>
          제 1 조 (목적)
          ...
          (시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
			...
			<div class="join-div-labelwrapper">
				<input type="checkbox" id="agreeTerms" required> <label
					for="agreeTerms">이용약관에 동의합니다.</label><br><br>
			</div>

			<!-- ✅ 개인정보 처리방침 동의 -->
			<h4 class="join-p-labelagree">개인정보 처리방침 동의</h4><br>
			<div class="join-div-wrapperprivacy">
				<textarea rows="10" cols="50" class="join-p-wrapperprivacy" readonly>
1. 개인정보의 수집항목 및 수집방법 
...
패치노트 지식의 숲에서는 정보주체의 회원 가입일로부터 서비스를 제공하는 기간 동안에 한하여 패치노트 지식의 숲사이트 서비스를 이용하기 위한 최소한의 개인정보를 보유 및 이용 하게 됩니다. 회원가입 등을 통해 개인정보의 수집·이용, 제공 등에 대해 동의하신 내용은 언제든지 철회하실 수 있습니다. 회원 탈퇴를 요청하거나 수집/이용목적을 달성하거나 보유/이용기간이 종료한 경우, 사업 폐지 등의 사유발생시 개인 정보를 지체 없이 파기합니다.
...
정보주체는 개인정보의 수집·이용목적에 대한 동의를 거부할 수 있으며, 동의 거부시 패치노트 지식의 숲에 회원가입이 되지 않으며, 패치노트 지식의 숲에서 제공하는 서비스를 이용할 수 없습니다.
  ...
  * 수탁업체
    - 행정자치부
      ...
      · 개인정보 보유 및 이용 기간 : 행정자치부에서는 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음
			...
			<div class="join-div-labelwrapper">
				<input type="checkbox" id="agreePrivacy" required> <label
					for="agreePrivacy">개인정보 처리방침에 동의합니다.</label><br>
			</div>

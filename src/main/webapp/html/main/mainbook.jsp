        ...
        <div class="div-page">
          <div class="div-intro-wrapper">
            ...
            <p class="p-intro-text">
              함께 성장하는 공간, 지식의 숲에 오신 것을 환영합니다. <br /><br />
              혼자 하는 공부가 막막할 때, 함께하면 더 즐겁고 의미 있어집니다. <br />
              지식의 숲에서는 스터디 모집과 자유로운 정보 공유를 통해 <br />
              서로 배우고 성장할 수 있습니다. <br /><br />
              배움의 길, 이제 혼자가 아닌 함께 걸어가요. <br />
        ...
        <div class="div-page">
          <div class="main-div-banner">
            <div class="main-div-slide1">
              <img src="${pageContext.request.contextPath}/asset/img/main/bn01.gif" alt="이미지1" class="main-img-banner01 main-div-banneractive" />
            </div>
            <div class="main-div-slide2">
              <img src="${pageContext.request.contextPath}/asset/img/main/bn02.gif" alt="이미지2" class="main-img-banner02" />
            </div>
          </div>
